# Olá 👋! Eu sou o Hélio Delfino

```

                   ##########                  helio@backend
              ###################             ─────────────────
           ##########################         OS: Windows 10 + WSL2 (Kali Linux)
        #############    #############        Host: Puntu Digital
       ###########          ###########        Kernel: Backend/DevOps Developer
      #########    ############    ######      IDE: VS Code
     #########   ##################  ####
     ########   ####################  ###      Languages.Programming: TypeScript, JavaScript, Python
    #########   ####################  ###      Languages.Stack: NestJS, Kafka, PostgreSQL, MongoDB
    #########    ##################  ####      Languages.Infra: AWS EKS, Kubernetes, Docker
     ########      ##############   ####
     #########                    #####        Hobbies.Security: Pentest, Kali Linux, Python CLI tooling
      #########                 #######        Hobbies.Study: Análise e Desenvolvimento de Sistemas (IESB)
       ###########            ##########
        #############    #############        Contact.LinkedIn: helio-delfino
           ##########################          Contact.GitHub: HelioHD
              ###################
                   ##########
